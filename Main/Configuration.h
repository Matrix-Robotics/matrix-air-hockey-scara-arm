...
#define CAM_PIX_HEIGHT 207
#define CAM_PIX_CENTER_X 157
#define CAM_PIX_CENTER_Y 103

// Camera geometric calibration
// The table is (752mm,480mm). Pixy camera frame is (315px,207px)
// Measure two known position (in mm) calculare the pixels on camera and generate divide: mm/pix
#define CAM_PIX_TO_MM 2.35 // Camera scale To calculate, you need to measure two points with known coordinates
