...
// void mapIKAngleToServo(int shoulderAngle, int elbowAngle) {
//     // shoulder: 140 deg => servo1 0 deg
//     // shoulder: 100 deg => servo1 40 deg
//     // elbow: -160 deg => servo2 0 deg
//     // shoulder: 90 deg => servo1 50 deg
//     // elbow: -90 deg => servo2 70 deg
